...
func (Link) LookupByString(string) (ipld.Node, error) {
	return mixins.Link{"types.Link"}.LookupByString("")
}
func (Link) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.Link{"types.Link"}.LookupByNode(nil)
}
func (Link) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.Link{"types.Link"}.LookupByIndex(0)
}
func (Link) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.Link{"types.Link"}.LookupBySegment(seg)
}
...
func (Link) AsBool() (bool, error) {
	return mixins.Link{"types.Link"}.AsBool()
}
func (Link) AsInt() (int, error) {
	return mixins.Link{"types.Link"}.AsInt()
}
func (Link) AsFloat() (float64, error) {
	return mixins.Link{"types.Link"}.AsFloat()
}
func (Link) AsString() (string, error) {
	return mixins.Link{"types.Link"}.AsString()
}
func (Link) AsBytes() ([]byte, error) {
	return mixins.Link{"types.Link"}.AsBytes()
}
...
func (_Link__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.LinkAssembler{"types.Link"}.BeginMap(0)
}
func (_Link__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.LinkAssembler{"types.Link"}.BeginList(0)
}
func (na *_Link__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.LinkAssembler{"types.Link"}.AssignNull()
...
func (_Link__Assembler) AssignBool(bool) error {
	return mixins.LinkAssembler{"types.Link"}.AssignBool(false)
}
func (_Link__Assembler) AssignInt(int) error {
	return mixins.LinkAssembler{"types.Link"}.AssignInt(0)
}
func (_Link__Assembler) AssignFloat(float64) error {
	return mixins.LinkAssembler{"types.Link"}.AssignFloat(0)
}
func (_Link__Assembler) AssignString(string) error {
	return mixins.LinkAssembler{"types.Link"}.AssignString("")
}
func (_Link__Assembler) AssignBytes([]byte) error {
	return mixins.LinkAssembler{"types.Link"}.AssignBytes(nil)
}
