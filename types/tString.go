...
func (String) LookupByString(string) (ipld.Node, error) {
	return mixins.String{"types.String"}.LookupByString("")
}
func (String) LookupByNode(ipld.Node) (ipld.Node, error) {
	return mixins.String{"types.String"}.LookupByNode(nil)
}
func (String) LookupByIndex(idx int) (ipld.Node, error) {
	return mixins.String{"types.String"}.LookupByIndex(0)
}
func (String) LookupBySegment(seg ipld.PathSegment) (ipld.Node, error) {
	return mixins.String{"types.String"}.LookupBySegment(seg)
}
...
func (String) AsBool() (bool, error) {
	return mixins.String{"types.String"}.AsBool()
}
func (String) AsInt() (int, error) {
	return mixins.String{"types.String"}.AsInt()
}
func (String) AsFloat() (float64, error) {
	return mixins.String{"types.String"}.AsFloat()
}
func (n String) AsString() (string, error) {
	return n.x, nil
}
func (String) AsBytes() ([]byte, error) {
	return mixins.String{"types.String"}.AsBytes()
}
func (String) AsLink() (ipld.Link, error) {
	return mixins.String{"types.String"}.AsLink()
}
...
func (_String__Assembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
	return mixins.StringAssembler{"types.String"}.BeginMap(0)
}
func (_String__Assembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
	return mixins.StringAssembler{"types.String"}.BeginList(0)
}
func (na *_String__Assembler) AssignNull() error {
	...
	case allowNull:
		*na.m = schema.Maybe_Null
		return nil
	case schema.Maybe_Absent:
		return mixins.StringAssembler{"types.String"}.AssignNull()
...
func (_String__Assembler) AssignBool(bool) error {
	return mixins.StringAssembler{"types.String"}.AssignBool(false)
}
func (_String__Assembler) AssignInt(int) error {
	return mixins.StringAssembler{"types.String"}.AssignInt(0)
}
func (_String__Assembler) AssignFloat(float64) error {
	return mixins.StringAssembler{"types.String"}.AssignFloat(0)
}
...
func (_String__Assembler) AssignBytes([]byte) error {
	return mixins.StringAssembler{"types.String"}.AssignBytes(nil)
}
func (_String__Assembler) AssignLink(ipld.Link) error {
	return mixins.StringAssembler{"types.String"}.AssignLink(nil)
}
